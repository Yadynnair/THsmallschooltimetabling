...
st.set_page_config(
    page_title="จัดตารางเรียนตารางสอนสำหรับโรงเรียนขนาดกลางและขนาดเล็ก",
    page_icon="📚",
)
...
st.title('ยินดีต้อนรับเข้าสู่โปรแกรมช่วยจัดตารางสอนสำหรับโรงเรียนขนาดกลางและขนาดเล็ก')
st.markdown('''
    โปรแกรมนี้เป็นต้นแบบที่จัดทำขึ้นโดยคาดหวังที่จะแบ่งเบาภาระงานของครูในโรงเรียนขนาดกลางและขนาดเล็กในประเทศไทย
...
# Visualize upload data
    ...
    #Adjusting Conditions
        ...
        with st.expander('ชื่อคาบกิจกรรมที่ต้องการกำหนดเอง (ไม่เกิน 10 กิจกรรม)'):
            self_manage = st_tags(label='',text='พิมพ์ชื่อวิชาแล้วกด enter เพื่อเพิ่มวิชา',value=['แนะแนว','ลูกเสือ'], maxtags = 10)
